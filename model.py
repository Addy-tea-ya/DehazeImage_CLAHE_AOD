...
class AODnet(nn.Module):
    def __init__(self):
        ...
        self.conv5 = nn.Conv2d(in_channels=18, out_channels=3, kernel_size=3, stride=1, padding=1)
        self.b = 1
...
class AODnet1(nn.Module):
    def __init__(self):
        super(AODnet1, self).__init__()
